...
if(isset($_SESSION['start']) && isset($_SESSION['end'])){ 
						$stringQuery1 = "SELECT  delivery.delivery_id, delivery.delivery_datetime, product.product_id, product.product_name, product.product_type, delivery.delivery_unitprice, delivery.delivery_numberofunits, delivery.delivery_unitofmeasure, delivery.delivery_totalcostamount, supplier.supplier_id, supplier.supplier_name, branch.branch_id, branch.branch_name, employee.employee_id, employee.employee_firstname, delivery.deleteStatus,
                    ...
                    AND delivery.delivery_datetime >= '$_SESSION[start]'
            AND delivery.delivery_datetime <= '$_SESSION[end]' 
  ...
  $sum_sales= 0;   
	...
	$this->Ln();
 						...
 						$stringQuery = "SELECT  delivery.delivery_id, delivery.delivery_datetime, product.product_id, product.product_name, product.product_type, delivery.delivery_unitprice, delivery.delivery_numberofunits, delivery.delivery_unitofmeasure, delivery.delivery_totalcostamount, supplier.supplier_id, supplier.supplier_name, branch.branch_id, branch.branch_name, employee.employee_id, employee.employee_firstname, delivery.deleteStatus,
