...
<div class="btn-group">
  <a class="button" href="branchPrint.php"  target="_blank"><span class="glyphicon glyphicon-print"> Print</span>
                    ...
                    if($result = mysqli_query($conn, $sql)){
                        ...
                        if(mysqli_num_rows($result) > 0){
                            ...
                            echo "<center><table class='table'></center>";
                                ...
                                echo "<thead>";
                                echo "<caption><h1>Branch List Report</h1></caption>";

                                    echo "<tr style='width: 100px;'>";

                                        echo "<th style='width: 150px;'>Branch Id</th>";
                                ...
                                while($row = mysqli_fetch_assoc($result)){
                                    ...
                                    echo "<tr>";
                                        ...
                                        echo "<td> ", "<center>". $row['branch_id'] . "</center>", "</td>";
