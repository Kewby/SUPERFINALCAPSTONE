<!--shows all leyte branch employees in employee master list-->
...
<div class="btn-group">
  <a class="button" href="leyteBranchPrint.php"  target="_blank"><span class="glyphicon glyphicon-print"> Print</span>
...
<?php
                    ...
                    CASE WHEN employee.isAdmin = 1 THEN 'Yes' ELSE 'No' END AS isAdmin ,

                    CASE WHEN employee.deleteStatus = 1 THEN 'Deleted' ELSE 'Not Delete' END AS deleteStatus
                    ...
                    if($result = mysqli_query($conn, $sql)){
                        ...
                        if(mysqli_num_rows($result) > 0){
                            ...
                            echo "<center><table class='table'></center>";
                                ...
                                echo "<thead>";
                                echo "<caption><h1>Employee Master List Report (Leyte Branch)</h1></caption>";
