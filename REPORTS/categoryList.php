...
<div class="btn-group">
  <a class="button" href="categoryPrint.php"  target="_blank"><span class="glyphicon glyphicon-print"> Print</span>
  </a>
                    ...
                    if($result = mysqli_query($conn, $sql)){
                        ...
                        if(mysqli_num_rows($result) > 0){
                            ...
                            echo "<center><table class='table'></center>";
                                ...
                                echo "<thead>";
                                echo "<caption><h1>Category List Report</h1></caption>";

                                    echo "<tr style='width: 100px;'>";

                                        echo "<th style='width: 150px;'>Category Id</th>";
